...
`a token is used for authenticating`

- [ ] What steps can you take in your web apps to keep your data secure?

`follow current standards for security, test apps for security holes`

- [ ] Describe how web servers work.

`Web servers basically dispense a web page when requested using a web client`

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing 
with APIs/Servers.
